        ...
        <div className="space-y-4 text-center md:text-left">
          ...
          <div className="flex items-center justify-center md:justify-start space-x-6 pt-4">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-sky-500 to-violet-600 text-white px-4 py-2 rounded-full shadow-lg hover:scale-105 transition-all duration-200 group focus:outline-none focus:ring-2 focus:ring-sky-400 whitespace-nowrap"
